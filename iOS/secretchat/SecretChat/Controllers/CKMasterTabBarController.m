...
@interface CKMasterTabBarController ()
@property UITabBarItem *chatItem;
@property UITabBarItem *findItem;
@property UITabBarItem *settItem;

@property CKFriendsListController     *chatVC;
@property CKFriendRequestController *findVC;
@property CKSettingController *settVC;



@end

@implementation CKMasterTabBarController
