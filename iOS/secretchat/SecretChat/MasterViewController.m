...
//    sendMessage(0x1001,(uint8_t*)([[NSString stringWithFormat:@"%@|%@|%@|%@|%@|%@|",PROTOCOL_VERSION,uuid,ACCESSTOKEN_HARDCODING,device.systemVersion,APP_VERSION,device.localizedModel] cStringUsingEncoding:NSUTF8StringEncoding]));
}
