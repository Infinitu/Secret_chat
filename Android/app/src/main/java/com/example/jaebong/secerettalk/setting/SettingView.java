package com.example.jaebong.secerettalk.setting;
...
public class SettingView extends ActionBarActivity implements View.OnClickListener{
    ...
    private LinearLayout nickNameTagLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nickNameTagLayout = (LinearLayout)findViewById(R.id.setting_layout_getNicknameTag);
        ...
        nickNameTagLayout.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.setting_imageButton_profileImage :
                ...
                break;
            case R.id.setting_layout_getNicknameTag :
            case R.id.setting_tv_getNicknameTag :
                Toast toast = Toast.makeText(this,"클립보드에 복사되었습니다.",Toast.LENGTH_LONG);
                toast.show();
                proxy.sendAccessTokenForNicknameTag();
                break;
